...
parser.add_argument(
    "--ShiftScaleRotateMode", type=int, default=4
...
if __name__ == "__main__":
    ...
    wandb_logger = WandbLogger(project="NunBody", name=f"{args.backbone}_{args.archi}_BS")
    ...
    early_stop_callback = EarlyStopping(
        monitor="val/loss", min_delta=0.00, patience=100, verbose=False, mode="min"
    )
